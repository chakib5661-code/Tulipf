                  ...
                  >
                    <div className="flex items-start gap-3">
                      <img
                        ...
                        onError={(e) => {
                          (e.currentTarget as HTMLImageElement).src = isExtrait ? '/tulip-extrait-default.jpg' : 'https://images.unsplash.com/photo-1523293182086-7651a899d37f?w=200';
                        }}
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="py-3.5 px-4">
                            ...
                            >
                              {isExtrait ? <Sparkles className="w-3 h-3 text-amber-700" /> : <Layers className="w-3 h-3 text-indigo-700" />}
                              {product.family}
                            </span>
                          </td>
